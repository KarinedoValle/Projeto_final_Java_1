...
public class Presidente extends Funcionario {
	...
	public Presidente(String cpf, String nome, int senha, String tipo, String cargo) {
		super(cpf, nome, senha, tipo, cargo);
	...
	public static void menu(Conta conta) {
		...
		if (op1 == 1) {
			...
			do {
				...
				System.out.println("7 - Relatório Valor Total Capital Armazenado no Banco");
				System.out.print(" Opção: ");
				op2 = scan.nextInt();
			} while (op2 < 1 || op2 > 7);
			...
			// REVISAR CONTAS
				...
				System.out.println("------------------------------------------------------------");
				System.out.println(
						"             Relatório Informações Nome/CPF/Agência de todos os clientes              ");
				System.out.println("------------------------------------------------------------");
				System.out.println("Simulação");
				System.out.print("Digite o valor que deseja simular: ");
				valor = scan.nextDouble();
			...
			// REVISAR CONTAS
				...
				System.out.println("");
				System.out.println("------------------------------------------------------------");
				System.out.println("             Relatório Valor Total Capital Armazenado no Banco              ");
				System.out.println("------------------------------------------------------------");
				System.out.println("Simulação");
				System.out.print("Digite o valor que deseja simular: ");
				valor = scan.nextDouble();
