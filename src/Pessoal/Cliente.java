...
public class Cliente extends Pessoa {
	...
	public Cliente(String cpf, String nome, int senha, String tipo) {
		super(cpf, nome, senha, tipo);
	}

	// menu
	public void menu(Conta conta, Pessoa pessoa) throws IOException {
		...
		if (op3 == 11) {
			...
			System.out.println(conta.sacar(valor, conta, pessoa));
		} else if (op3 == 12) {
			System.out.println("");
			System.out.println("");
			System.out.println("");
			...
			valor = scan.nextDouble();
			System.out.println(conta.depositar(valor, conta, pessoa));
		} else if (op3 == 13) {
			System.out.println("");
			System.out.println("");
			System.out.println("");
			...
			System.out.println(conta.transferir(valor, conta, destinatario, pessoa));
		} else if (op3 == 14) {
			System.out.println("------------------------------------------------------------");
