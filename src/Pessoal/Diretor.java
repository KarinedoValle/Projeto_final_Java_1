...
public class Diretor extends Funcionario {
	...
	public Diretor(String cpf, String nome, int senha, String tipo, String cargo, int agencia) {
	...
	public static void menu(Conta conta) {
		...
		// REVISAR CONTAS
			...
			System.out.println("------------------------------------------------------------");
			System.out
					.println("             Relatório Informações Nome/CPF/Agência de todos os clientes              ");
			System.out.println("------------------------------------------------------------");
			System.out.println("Simulação");
			System.out.print("Digite o valor que deseja simular: ");
			valor = scan.nextDouble();
	...
	//To String
			...
			public String toString() {
				return "--Diretor instanciado-- \nSenha: " + getSenha() + "\nCPF: " + getCpf() + "\nCargo: " + getCargo() + "\nId Agência: " + getAgencia();
			}
